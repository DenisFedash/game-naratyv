...
import GameStartRulesPopup from "../utils/GameStartRulesPopup/GameStartRulesPopup";
import { CreateMeet } from "../GameSettings/CreateMeet";
...
export const FieldGame = () => {
  ...
  const handleDrawingButtonClick = (playerId) => {
    setActivePlayer(playerId);
    startTimer();
  };

  const isDrawingDisabled = (playerId) => {
    return activePlayer !== null && activePlayer !== playerId;
  };


  return (
    <div className="layout relative">
      <Avatars activePlayerId={activePlayer} />
      <div className="absolute mt-[210px] ml-[300px]">
      {/* <GameStartRulesPopup /> */}
      </div>
        ...
        <div>
          <div className=" bg-main-white flex items-center justify-between h-[66px] shadow-panel-shadow mb-2">
            ...
            <div className=" border-x border-main-grey w-[512px] px-6 h-full py-3.5 mr-[90px]">
              <input
                type="text"
                value={meetLink} onChange={handleInputChange} 
