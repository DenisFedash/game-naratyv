...
export const GameSettings: FC<GameTopicProps> = ({ textTr, lang, id }) => {
	...
	const handleCopy = () => {
		navigator.clipboard.writeText(
			"http://localhost:3000/ua/rules/naratyv-creatyv/player"
		);
	};
		...
		<div className="flex flex-col">
			<div className="layout relative flex py-8 items-start">
				...
				<div className="mr-[92px] relative flex flex-col justify-center items-center">
					...
					<div className="relative bg-main-white border border-main-font-color rounded-lg shadow-3xl font-bold flex items-center justify-end w-[512px] h-16 focus:outline-none transform transition-transform duration-200 ease-in-out active:scale-90 mb-10">
						<div
						...
						>
							<p className="text-2xl">
								{hovered ? (
									<Link href={`/${lang}/rules/${id}/player`}>
										http://rules/player
									</Link>
								) : (
									textTr.linkGame
						...
						<div
							...
							className="border relative items-end w-[84px] h-16 bg-main-yellow p-2.5 rounded-r-lg cursor-pointer"
						>
							<Image
								src={copyBtn}
								alt="copy-button"
