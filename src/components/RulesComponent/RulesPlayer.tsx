   ...
   <div className="layout flex flex-col h-full items-center">
      ...
      <RuleCard className="w-[1020px] h-60 mb-24 justify-center items-start bg-main-white">
        <ul className="mb-14 text-justify">
          <li className="list-disc text-3xl text-justify">
            {lang === "ua" ? rulesByRole[0].descriptionUa.description1 : rulesByRole[0].descriptionEn.description1}</li>
          <li className="list-disc text-3xl text-justify">
            {lang === "ua" ? rulesByRole[0].descriptionUa.description2 : rulesByRole[0].descriptionEn.description2}</li>
          <li className="list-disc text-3xl text-justify">
            {lang === "ua" ? rulesByRole[0].descriptionUa.description3 : rulesByRole[0].descriptionEn.description3}</li> 
        </ul>     
      </RuleCard>
      </div>
